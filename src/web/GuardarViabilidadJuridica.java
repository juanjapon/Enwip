...
public class GuardarViabilidadJuridica  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarViabilidadJuridica() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String viabilidadJuridica = request.getParameter("ViabilidadJuridica");
             
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarViabilidadJuridica(viabilidadJuridica,planId));
                 out.close();
