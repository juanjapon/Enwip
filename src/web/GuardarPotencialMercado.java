...
public class GuardarPotencialMercado  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarPotencialMercado() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String potencialMercado = request.getParameter("PotencialMercado");
         
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarPotencialMercado(potencialMercado,planId));
                 out.close();
