...
import server.entities.Dias;
import server.session.FormularioEnwipRemote;

public class CargarDiasFormulario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CargarDiasFormulario() {
        super();
		...
		StringBuilder objSecciones;
         // Crea un array de objetos JSON con cada tema de la tabla
           ...
           for( int i=0;i<dias.size();i++ )
            { objSecciones.append("{\"Dia\":\"");
            objSecciones.append(dias.get(i).getDia());
            objSecciones.append("\"},");
            }            
