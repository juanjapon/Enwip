...
public class GuardarEntradaMercado  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarEntradaMercado() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String entradaMercado = request.getParameter("EntradaMercado");
            
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarEntradaMercado(entradaMercado,planId));
                 out.close();
