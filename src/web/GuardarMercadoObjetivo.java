...
public class GuardarMercadoObjetivo extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarMercadoObjetivo() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String mercadoObjetivo = request.getParameter("MercadoObjetivo");
          
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarMercadoObjetivo(mercadoObjetivo,planId));
                 out.close();
