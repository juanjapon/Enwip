...
public class GuardarColaborador extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             int colaborador =Integer.parseInt(request.getParameter("id"));
             int tipo=Integer.parseInt(request.getParameter("tipo"));
             
             
                
             	esr.guardarColaborador(idea,colaborador,tipo);
