...
public class GuardarProductosServicios  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarProductosServicios() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String productosServicios = request.getParameter("ProductosServicios");
          
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarProductosServicios(productosServicios,planId));
                 out.close();
