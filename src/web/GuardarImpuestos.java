...
public class GuardarImpuestos extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarImpuestos() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
             ...
             {   
        		 ...
        		 Vector<String>  datos=new Vector();
        		   ...
        		   System.out.println("tamaño matriz "+(nombres.size())/2);
        	        String impuestos[][]=new String[(nombres.size())/2][3];
        	        for(int i=0,j=0;i<nombres.size();i+=2,j++){
        	        	...
        	        	impuestos[j][0]=aux[1];
        	        	impuestos[j][1]=datos.get(i);
        	        	impuestos[j][2]=datos.get(i+1);
        	        ...
        	        for(int i=0;i<impuestos.length;i++){
        	        	for(int j=0;j<impuestos [i].length;j++){
        	        		System.out.print(" "+impuestos[i][j]);
        	        	}
        	        	System.out.println();
        	        }
             ...
             String planId=request.getParameter("planId");
                 ...
                 out.print(esr.guardarImpuestos(impuestos,planId));
                 out.close();
