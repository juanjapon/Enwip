...
public class GuardarPrecioPS  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarPrecioPS() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String precioPS = request.getParameter("PrecioPS");
           
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarPrecioPS(precioPS,planId));
                 out.close();
