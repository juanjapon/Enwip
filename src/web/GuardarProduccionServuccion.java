...
public class GuardarProduccionServuccion  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarProduccionServuccion() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String produccionServuccion = request.getParameter("ProduccionServuccion");
          
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarProduccionServuccion(produccionServuccion,planId));
                 out.close();
