...
/**
 * Servlet implementation class CargarDatosFormulario
 */
public class CargarPaisesFormulario extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CargarPaisesFormulario() {
        super();
		...
		StringBuilder objSecciones;
         // Crea un array de objetos JSON con cada tema de la tabla
           ...
           for( int i=0;i<paises.size();i++ )
            ...
            objSecciones.append(paises.get(i).getNombre());
            objSecciones.append("\"},");
            }            
