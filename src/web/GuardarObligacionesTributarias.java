...
public class GuardarObligacionesTributarias  extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GuardarObligacionesTributarias() {
        super();
      ...
      //Recupera todos los nombre de parámetros recibidos en la petición.
        ...
        { 
        	...
        	System.out.println(request.getParameter(nombres1.nextElement()));
             ...
             String obligacionesTributarias = request.getParameter("ObligacionesTributarias");
         
             String planId=request.getParameter("planId");
                 
           
                 out.print(esr.guardarObligacionesTributarias(obligacionesTributarias,planId));
                 out.close();
