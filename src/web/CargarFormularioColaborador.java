...
public class CargarFormularioColaborador extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private EnwipSesionRemote esr;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CargarFormularioColaborador(){
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String datos;
		datos=esr.cargarFormularioColaborador(Integer.parseInt(request.getParameter("Id")));
