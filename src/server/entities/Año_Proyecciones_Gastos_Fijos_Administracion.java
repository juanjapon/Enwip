...
@NamedQueries( 
		{
		  @NamedQuery(name="Año_Proyecciones_Gastos_Fijos_Administracion.findByGastoId",query="SELECT d FROM Año_Proyecciones_Gastos_Fijos_Administracion d WHERE d.gastoFijoId= :id"),
		  @NamedQuery(name = "Año_Proyecciones_Gastos_Fijos_Administracion.findAll", query = "SELECT n FROM Año_Proyecciones_Gastos_Fijos_Administracion n")
		}	
		
)
@IdClass(Año_Proyecciones_Gastos_Fijos_AdministracionPK.class)
@Table(name="AÑO_PROYECCIONES_GASTOS_FIJOS_ADMINISTRACION")
public class Año_Proyecciones_Gastos_Fijos_Administracion implements Serializable {
	...
	private int añoId;
	@Id
	@Column(name="GASTOS_FIJOS_ADMINISTRACIONGASTO_FIJO_ID")
