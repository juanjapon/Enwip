...
@NamedQueries( 
		{
		  @NamedQuery(name="Año_Proyecciones_Costos_Fijos.findByCostoId",query="SELECT d FROM Año_Proyecciones_Costos_Fijos d WHERE d.costosId= :id"),
		  @NamedQuery(name = "Año_Proyecciones_Costos_Fijos.findAll", query = "SELECT n FROM Año_Proyecciones_Costos_Fijos n")
		}	
		
)
@IdClass(Año_Proyecciones_Costos_FijosPK.class)
@Table(name="AÑO_PROYECCIONES_COSTOS_FIJOS")
public class Año_Proyecciones_Costos_Fijos implements Serializable {
	...
	private int añoId;
	@Id
	@Column(name="COSTOS_FIJOSCOSTO_FIJO_ID")
