...
@NamedQueries( 
		{
		  @NamedQuery(name="Año_Proyecciones_Gastos_Ventas.findByCostoId",query="SELECT d FROM Año_Proyecciones_Gastos_Ventas d WHERE d.gastoVentaId= :id"),
		  @NamedQuery(name = "Año_Proyecciones_Gastos_Ventas.findAll", query = "SELECT n FROM Año_Proyecciones_Gastos_Ventas n")
		}	
		
)
@IdClass(Año_Proyecciones_Gastos_VentasPK.class)
@Table(name="AÑO_PROYECCIONES_GASTOS_VENTAS")
public class Año_Proyecciones_Gastos_Ventas implements Serializable {
	...
	private int añoId;
	@Id
	@Column(name="GASTOS_VENTASGASTO_VENTA_ID")
